  ...
  return (
    ...
    >
      ...
      <div className="relative size-10" aria-hidden>
        ...
        >
          <span className="absolute top-0 left-1/2 size-2 -translate-x-1/2 -translate-y-1/2 rounded-full bg-brand" />
        </motion.span>
        <motion.span
          className="absolute inset-[7px] rounded-full bg-brand/15"
